...
Make Dataset
[UE0, UE1, UE2, UE3, UE4, UE5, UE7, UE8 ,1_SelUE0, 1_SelUE1, 1_SelUE2, 1_SelUE3, 1_SelUE4, 1_SelUE5, 1_SelUE6, 1_SelUE7, 2_SelUE0, 2_SelUE1, 2_SelUE2, 2_SelUE3, 2_SelUE4, 2_SelUE5, 2_SelUE6, 2_SelUE7]
"""
import random
import math
import numpy
...
def MakeCSVFile(strFolderPath, strFilePath, aryOfDatas):
    ...
    wr = csv.writer(f)
    wr.writerow(["UE0", "UE1", "UE2", "UE3","UE4", "UE5", "UE6", "UE7", "1_SelUE0", "1_SelUE1", "1_SelUE2", "1_SelUE3", "1_SelUE4", "1_SelUE5", "1_SelUE6", "1_SelUE7", 
