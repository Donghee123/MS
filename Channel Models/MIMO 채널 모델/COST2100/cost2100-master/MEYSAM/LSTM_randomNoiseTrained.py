...
with tf.Session() as sess:
    ...
    for epoch_cntr in range(num_epochs):
        for batch_cntr in range(num_batches):
            ...
            if batch_cntr  % (num_batches-1) == 0:# % num_batches == 0:
                print('batch_cntr',batch_cntr)
                print('epoch_cntr',epoch_cntr)
                x_test_batch, y_test_batch = NextBatch(X_test,Y_test,1024)  # NextBatch(X_test_noisy,Y_test,1024)
