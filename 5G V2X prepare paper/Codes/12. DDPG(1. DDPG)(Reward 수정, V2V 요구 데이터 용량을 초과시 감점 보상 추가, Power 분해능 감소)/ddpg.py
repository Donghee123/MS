...
class DDPG(object):
    def __init__(self, nb_states, nb_actions, args, num_vehicle):
        ...
        self.action_all_with_power = np.full([self.num_vehicle, 3, 2], -1,dtype = 'float')   # this is actions that taken by V2V links with power
        self.action_all_with_power_training = np.full([20, 3, 2],-1,dtype = 'float')   # this is actions that taken by V2V links with power
