...
if __name__ == '__main__':
    ...
    parser.add_argument('--warmup', default=2000, type=int, help='train iters each timestep') # 5000
    parser.add_argument('--updates_per_step', default=10, type=int, help='update per step') #
