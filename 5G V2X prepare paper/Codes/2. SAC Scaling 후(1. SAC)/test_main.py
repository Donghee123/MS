...
actor_path = './models/sac_actor_V2X_Model_'
critic_path = './models/sac_critic_V2X_Model_'
for nVeh in arrayOfVeh:      
      ...
      #학습 
      v2i_Sumrate, v2v_Sumrate, probability = agent.play(actor_path= actor_path, critic_path= critic_path ,n_step = 100, n_episode = 20)
