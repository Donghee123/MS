            ...
            for k in range(1):
                ...
                for i in range(len(env.vehicles)):
                    ...
                    for j in range(0,3): 
                        ...
                        selPower = selPowerdBm + action[0]
                        
                        if selPower > 23.0:
                            selPower = 23.0
                            
                        agent.action_all_with_power_training[i, j, 1] = selPower# PowerdBm을 저장함.
                                            
                        #선택한 power level과 resource block을 기반으로 reward를 계산함.
                        reward = env.act_for_ddpg_training_using_compactRate(agent.action_all_with_power_training, [i,j], args.datarate_margin_sacle) 
                        ...
                        for k in range(test_sample):
                            ...
                            for i in range(len(env.vehicles)):
                                ...
                                for j in sorted_idx:                   
                                    ...
                                    agent.action_all_with_power[i, j, 1] = selPower
...
def main(_):
    ...
    parser.add_argument('--datarate_margin_sacle', default=2, type=float, help='') 
    ...
    parser.add_argument('--train_iter', default=200000, type=int, help='train iters each timestep') # 200000
