...
class SAC(object):
    ...
    def train_from_replaData(self, replayDirectoryPath): 
        ...
        filenames = os.listdir(replayDirectoryPath)
        
        for filename in filenames:
            
            #load replay memory 
            self.memory.load(replayDirectoryPath + '/' + filename)
            
            #add random replay data
            ...
            #only use replay data
            for index in range(self.train_step):                
                ...
                print('update step : ', index)
                print('policy loss : ', policy_loss)
               
                                                      
            # test for each traindata
            number_of_game = 10
