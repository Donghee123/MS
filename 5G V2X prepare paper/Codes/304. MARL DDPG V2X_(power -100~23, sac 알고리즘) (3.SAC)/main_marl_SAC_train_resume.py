# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 10:33:45 2021
...
if __name__ == '__main__':
    ...
    parser.add_argument('--warmup', default=500, type=int, help='train iters each timestep') # 200000
    ...
    for ind_agent in range(n_veh * n_neighbor):  # initialize agents
        ...
        loadmodelpath = totalModelPath + '/agent_' + str(ind_agent) + '/agent' + str(ind_agent)
        agent.load_models(loadmodelpath)
