...
def main(_):
  ...
  for nVeh in arrayOfVeh:      
      ...
      with tf.Session(config=config) as sess:
        ...
        v2i_Sumrate, v2v_Sumrate, probability, powersum, varpower, stdpower, selcted_prob_23dBm, selcted_prob_10dBm, selcted_prob_5dBm = agent.playwithKeras(n_step = 100, n_episode = 20, random_choice = False, use_async = use_async)
